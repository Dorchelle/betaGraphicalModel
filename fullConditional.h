...
PriorPartitionResult fullPartition(double b, double M, Vector& SS, Vector& CS, const Matrix& IDH, Vector& mu, double b_mu, Vector& alpha, double b_alpha, const Matrix& lambda_1, const Matrix& theta, const Matrix& X, int m_neal = 3);
